public class RoadBike extends Bike implements RoadParts {
	...
	public String toString() {
		return "This Roadbike bike has " + tyreWidth + 
		"mm tyres and a post height of " + postHeight + ".";
	}
	...
	public RoadBike(String handleBars, String frame, String tyres, String seatType, 
				int numGears, int tyreWidth, int postHeight) {
